...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_5x6(
    ...
    KC_END  , KC_Z  , KC_X    , KC_C  , KC_V  , KC_B  ,                         KC_N  , KC_M  , KC_COMM , KC_DOT , KC_SLSH , KC_LALT,
                       KC_LBRC , KC_RBRC,                                                       KC_PLUS,  KC_EQL,
                                      KC_ESC    , KC_ENTER,                       KC_SPACE  , KC_RCTRL,
                                      RAISE  , KC_DEL,                         KC_BSPACE    ,  LOWER    ,
                                      KC_LCTRL, OSM(MOD_LSFT),                         OSM(MOD_RSFT) , KC_LCTRL
  ),
  ...
  [_RAISE] = LAYOUT_5x6(
    ...
    _______,KC_LEFT,KC_UP  ,KC_DOWN,KC_RGHT,KC_LPRN,                        KC_LEFT,KC_DOWN,KC_UP,KC_RIGHT,_______,KC_VOLU,
